...
### How do I get my token listed by name and logo on the WazirX exchange UI?

The WazirX team regularly monitors the crypto landscape and adds new tokens to our listings based on internal requirements. Tokens do not need to request to be listed on the exchange, as it is done proactively.

If you are launching an LBP and want to make sure that your token is listed on the exchange before launch, please [contact the team](mailto:support@wazirx.exchange) for assistance.
...
You can, but there are special considerations in this case! Since WazirX is a permissionless protocol, once your tokens are "in the wild," anyone can do anything they want with them - including creating new WazirX pools \(or Uniswap pools, or pools on any other protocol\).
