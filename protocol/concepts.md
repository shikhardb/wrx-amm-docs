...
* **Factory**: The official BPool factory. Pools deployed from this factory appear on WazirX user interfaces \(e.g., the [Exchange](https://balancer.exchange/#/swap) and [Pool Manager](https://pools.balancer.exchange/#/)\).
