...
All WazirX Protocol smart contracts were coded supporting a protocol-level exit fee to be charged that goes to WazirX team for supporting the development of the protocol. However, after careful consideration the WazirX team decided to launch the first version of WazirX without any protocol fees whatsoever. \(For technical reasons, this is unlikely to change.\)
